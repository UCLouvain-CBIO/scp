...
if(load_fresh){
  ...
  ev<-read.delim("../../extdata/specht2019/ev_updated.txt")
  design<-read.csv("../../extdata/specht2019/annotation_fp60-97.csv")
  batch<-read.csv("../../extdata/specht2019/batch_fp60-97.csv")
...
if(iso_cor){
  ...
  cor.mat<-as.matrix(read.csv("../../extdata/specht2019/te269088_lot_correction.csv")[,-1])
